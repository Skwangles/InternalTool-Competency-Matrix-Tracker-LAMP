...
if(isset($_POST['UserID']) && isset($_POST['Value']) && ($_SESSION["isAdmin"] == 1 || $_SESSION["userid"] == $_POST["UserID"])){//Chec for correct information, and ensure correct permission to execute the change
